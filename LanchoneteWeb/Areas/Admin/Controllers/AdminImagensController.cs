...
namespace LanchoneteWeb.Areas.Admin.Controllers
{
    ...
    public class AdminImagensController : Controller
    {
        ...
        public IActionResult GetImagens()
        {
            ...
            var userImagePath = Path.Combine(_hostEnvironment.WebRootPath, _myConfig.NomePastaImagensProdutos);
            ...
            if (files.Length == 0)
            {
                ViewData["Errp"] = $"Nenhum arquivo encontrado na pasta {userImagePath}";
            }
